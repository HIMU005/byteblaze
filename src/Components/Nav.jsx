...
const Nav = () => {
    ...
    return (
        <div className="navbar bg-base-100 shadow-lg px-4 sm:px-8 fixed z-20">
            <div className="flex-1">
                <Link to={'/'} className="btn btn-ghost normal-case text-secondary text-2xl">Byte<span className="text-primary">Blaze</span></Link>
            </div>
            <div className="flex-none">
                <ul className="menu menu-horizontal px-1 sm: flex gap-5 font-bold">
